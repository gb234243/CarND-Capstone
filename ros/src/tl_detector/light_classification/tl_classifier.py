...
class TLClassifier(object):
    def __init__(self):
        ...
        # self.get_classification(np.zeros((600, 800, 3), dtype=np.uint8)) # Attempt to lose the 2 second start time...
    ...
    def get_classification(self, image):
        ...
        # endtime = time.time()
        # print("Inference took {:.4f} seconds".format(endtime - starttime))
